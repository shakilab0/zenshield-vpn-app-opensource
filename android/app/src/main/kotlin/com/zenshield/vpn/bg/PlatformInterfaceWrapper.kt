...
import com.vpnapp.zenshield.libbox.Libbox.InterfaceTypeCellular
import com.vpnapp.zenshield.libbox.Libbox.InterfaceTypeEthernet
import com.vpnapp.zenshield.libbox.Libbox.InterfaceTypeOther
import com.vpnapp.zenshield.libbox.Libbox.InterfaceTypeWIFI
import com.vpnapp.zenshield.libbox.LocalDNSTransport
import com.vpnapp.zenshield.libbox.NetworkInterface as LibboxNetworkInterface
import com.vpnapp.zenshield.libbox.NetworkInterfaceIterator
import com.vpnapp.zenshield.libbox.PlatformInterface
import com.vpnapp.zenshield.libbox.StringIterator
import com.vpnapp.zenshield.libbox.TunOptions
import com.vpnapp.zenshield.libbox.WIFIState
...
interface PlatformInterfaceWrapper : PlatformInterface {
    ...
    override fun getInterfaces(): NetworkInterfaceIterator {
        ...
        for (network in networks) {
            ...
            boxInterface.type = when {
                networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_WIFI) -> InterfaceTypeWIFI
                networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR) -> InterfaceTypeCellular
                networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_ETHERNET) -> InterfaceTypeEthernet
    ...
    override fun localDNSTransport(): LocalDNSTransport? {
        Log.d("PlatformInterface", "localDNSTransport() called, returning LocalResolver")
