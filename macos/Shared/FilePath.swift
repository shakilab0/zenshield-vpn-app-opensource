...
public enum FilePath {
    public static let packageName = {
        Bundle.main.infoDictionary?["BUNDLE_IDENTIFIER"] as? String ?? "unknown"
    }()
}
...
public extension FilePath {
    ...
    // Shared paths for system extension (must be readable by app and system extension)
    static let sharedBasePath = "/tmp/zenshield_shared"
    static let sharedWorkingPath = sharedBasePath
    static let sharedTempPath = "\(sharedBasePath)/Caches"
}
